...
public class Ejercicio02 {
    ...
    public static void main(String[] args) {
        ...
        int respuesta;
        // necesitabmos un rango mas grande, por eso pusimos el new int [5]
        // en cada iteracion el valor que este fuera de los rangos se añade al
        // string fuera de rango, dando un total de 7 valores fuera de rango
